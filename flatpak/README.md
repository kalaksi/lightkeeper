...
```bash
flatpak install --user runtime/org.kde.Sdk/x86_64/6.11
flatpak install --user org.kde.Platform/x86_64/6.11
flatpak install --user io.qt.qtwebengine.BaseApp/x86_64/6.11
