...
impl Module for RebuildBoot {
    fn new(_settings: &HashMap<String, String>) -> RebuildBoot {
        RebuildBoot {
...
impl CommandModule for RebuildBoot {
    ...
    fn get_display_options(&self) -> frontend::DisplayOptions {
        frontend::DisplayOptions {
            ...
            display_text: String::from("nixos-rebuild boot"),
            tab_title: String::from("nixos-rebuild boot"),
    ...
    fn get_connector_message(&self, host: Host, _parameters: Vec<String>) -> Result<String, LkError> {
        ...
        if host.platform.is_same_or_greater(platform_info::Flavor::NixOS, "20") {
            command.arguments(vec!["nixos-rebuild", "boot"]); 
        }
        else {
