...
impl ModuleFactory {
    ...
    fn load_modules(&mut self) {
        ...
        self.command_modules = vec![
            ...
            (command::internal::FileBrowserLsLinks::get_metadata(), command::internal::FileBrowserLsLinks::new_command_module),
            ...
            (command::internal::FileBrowserChmod::get_metadata(), command::internal::FileBrowserChmod::new_command_module),
            (command::internal::FileBrowserChown::get_metadata(), command::internal::FileBrowserChown::new_command_module),
            (command::internal::FileBrowserEdit::get_metadata(), command::internal::FileBrowserEdit::new_command_module),
            ...
            (command::podman::Restart::get_metadata(), command::podman::Restart::new_command_module),
            (command::podman::Inspect::get_metadata(), command::podman::Inspect::new_command_module),
            (command::podman::Shell::get_metadata(), command::podman::Shell::new_command_module),
            (command::podman::image::Remove::get_metadata(), command::podman::image::Remove::new_command_module),
            (command::podman::image::Prune::get_metadata(), command::podman::image::Prune::new_command_module),
            (command::podman::image::RemoteTags::get_metadata(), command::podman::image::RemoteTags::new_command_module),
            (command::podman::compose::Edit::get_metadata(), command::podman::compose::Edit::new_command_module),
            (command::podman::compose::Pull::get_metadata(), command::podman::compose::Pull::new_command_module),
            (command::podman::compose::Up::get_metadata(), command::podman::compose::Up::new_command_module),
            (command::podman::compose::Start::get_metadata(), command::podman::compose::Start::new_command_module),
            (command::podman::compose::Stop::get_metadata(), command::podman::compose::Stop::new_command_module),
            (command::podman::compose::Restart::get_metadata(), command::podman::compose::Restart::new_command_module),
            (command::podman::compose::Shell::get_metadata(), command::podman::compose::Shell::new_command_module),
            (command::podman::compose::Logs::get_metadata(), command::podman::compose::Logs::new_command_module),
            (command::podman::compose::Build::get_metadata(), command::podman::compose::build::Build::new_command_module),
            ...
            (command::systemd::service::Restart::get_metadata(), command::systemd::service::Restart::new_command_module),
