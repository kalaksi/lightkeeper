...
pub fn init_resources() {
    qrc!(resources_main,
        "src/frontend/qt" as "main" {
            ...
            "images/breeze/dark/arrow-up.svg" as "images/button/arrow-up",
            "images/breeze/dark/arrow-down.svg" as "images/button/arrow-down",
            "images/breeze/dark/go-next.svg" as "images/button/go-next",
            ...
            "images/breeze/dark/cloud-upload.svg" as "images/button/upload",
            ...
            "images/breeze/dark/edit-cut.svg" as "images/button/edit-cut",
            "images/breeze/dark/edit-paste.svg" as "images/button/edit-paste",
            ...
            "images/breeze/dark/notifications.svg" as "images/button/alerts",
            "images/breeze/dark/notifications-disabled.svg" as "images/button/alerts-disabled",
            ...
            "images/breeze/dark/network-connect.svg" as "images/button/network-connect",
            "images/breeze/dark/network-disconnect.svg" as "images/button/network-disconnect",
            ...
            "images/breeze/dark/view-list-tree.svg" as "images/button/view-list-tree",
    ...
    qrc!(resources_theme_light,
        "src/frontend/qt" as "main" {
            ...
            "images/breeze/light/document-preview.svg" as "images/button/view-document",
            ...
            "images/breeze/light/arrow-up.svg" as "images/button/arrow-up",
            "images/breeze/light/arrow-down.svg" as "images/button/arrow-down",
            "images/breeze/light/go-next.svg" as "images/button/go-next",
            ...
            "images/breeze/light/cloud-upload.svg" as "images/button/upload",
            ...
            "images/breeze/light/edit-cut.svg" as "images/button/edit-cut",
            "images/breeze/light/edit-paste.svg" as "images/button/edit-paste",
            ...
            "images/breeze/light/folder-new.svg" as "images/button/folder-new",
            "images/breeze/light/lock.svg" as "images/button/lock",
            "images/breeze/light/view-visible.svg" as "images/button/view-visible",
            ...
            "images/breeze/light/notifications.svg" as "images/button/alerts",
            "images/breeze/light/notifications-disabled.svg" as "images/button/alerts-disabled",
            ...
            "images/breeze/light/network-connect.svg" as "images/button/network-connect",
            "images/breeze/light/network-disconnect.svg" as "images/button/network-disconnect",
            ...
            "images/breeze/light/view-list-tree.svg" as "images/button/view-list-tree",
