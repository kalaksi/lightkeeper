...
pub struct ThemeModel {
    ...
    rowBackgroundColor: qt_property!(QString; CONST),
    rowBackgroundColorAlternate: qt_property!(QString; CONST),
...
impl ThemeModel {
    pub fn new(display_options: configuration::DisplayOptions) -> ThemeModel {
        ...
        ThemeModel {
            ...
            rowBackgroundColor: QString::from("#232629"),
            rowBackgroundColorAlternate: QString::from("#1b1e20"),
